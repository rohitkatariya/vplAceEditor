function keyLogger(time,selectionRange,selectedText,pressedKey,pastedText,logEvent,fileName,editorChanged){
                this.time=time;
...
function captureCut(event,editor,fileName){
    	...
    	return new keyLogger((new Date()).getTime(),editor.selection.getRange(),editor.getSelectedText(),null ,null ,"log_cut",fileName,null);
    }
function captureCopy(e,editor,fileName){
		console.log('Copy Detected');
		return new keyLogger((new Date()).getTime(),editor.selection.getRange(),editor.getSelectedText(),null ,null ,"log_copy",fileName,null);
	}
function capturePaste(e,editor,fileName){
		console.log('Paste Detected');
		return new keyLogger((new Date()).getTime(),editor.selection.getRange(),editor.getSelectedText(),null , e.text,"log_paste",fileName,null);
	}
function captureKey(e,editor,fileName,editorChanged){
		//console.log(e);	
		return new keyLogger((new Date()).getTime(),editor.selection.getRange(),editor.getSelectedText(),new getLogStringKeyhandler(e) ,null ,"log_key",fileName,editorChanged);
	}
